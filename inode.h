...
class inode_state {
   ...
   public:
      ...
      inode_ptr get_cwd();
      inode_ptr get_root();
      void set_cwd(inode_ptr cwd_new);
      void pwd_clean();
      int pwd_size();
      void pwd_pop();
      void pwd_push(string &dir);
      vector<string> get_pwd();
...
class inode {
   ...
   public:
      ...
      inode_t get_type();       //get class for type
...
class directory: public file_base {
   ...
   public:
      ...
      void set_map (const string&, inode_ptr&);     //insert <string ptr> into map
      map<string,inode_ptr> get_map ();
      void map_erase(string s);
};
